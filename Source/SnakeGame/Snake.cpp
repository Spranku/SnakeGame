...
void ASnake::BeginPlay()
{
	...
	//Но если изначально она означала см/сек,то теперь она будет абстрактно обозначать просто секунды. Раз в сколько секунд змейка будет перемещаться ровно на ElementSize;
